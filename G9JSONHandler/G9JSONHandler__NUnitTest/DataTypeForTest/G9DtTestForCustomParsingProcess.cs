...
namespace G9JSONHandler_NUnitTest.DataTypeForTest
{
    ...
    public class G9DtTestForCustomParsingProcess
    {
        ...
        /// </summary>
        [G9AttrCustomParser(typeof(G9CCustomParser1), nameof(G9CCustomParser1.StringToObject),
        ...
        /// </summary>
        [G9AttrCustomParser(typeof(G9CCustomParser2), nameof(G9CCustomParser2.StringToObject),
        ...
        /// </summary>
        [G9AttrCustomParser(typeof(G9CCustomParser3), nameof(G9CCustomParser3.StringToObject),
